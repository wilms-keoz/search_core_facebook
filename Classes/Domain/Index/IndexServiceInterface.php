...
/**
 * Used to abstract concrete Facebook API integration from indexer.
 *
...
{
    /**
     * Fetch result from Facebook and return as array.
     *
     ...
     * Parameters should be passed, they should only contain parameters from Facebook documentation.
     */
